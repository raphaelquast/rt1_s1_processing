...
python -u /eodc/private/tuwgeo/users/tle/code_new/rt1_s1_processing/rt1_input_vsc.py /eodc/private/tuwgeo/users/tle/code_new/rt1_s1_processing/vsc_scripts/config_vsc.ini -totalarraynumber 5 -arraynumber ${SLURM_ARRAY_TASK_ID}
echo "--------------------------------------------------"
date
echo "=================================================="
