...
python -u /eodc/private/tuwgeo/users/tle/code_new/rt1_s1_processing/rt1_input_loadstackparallel_pj7.py /eodc/private/tuwgeo/users/tle/code_new/rt1_s1_processing/config_pj7.ini -totalarraynumber 7 -arraynumber ${SLURM_ARRAY_TASK_ID}
echo "--------------------------------------------------"
date
echo "=================================================="
